...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fab-in fixed bottom-5 right-5 z-40 inline-flex items-center gap-2 rounded-full bg-whatsapp px-4 py-3 text-sm font-semibold text-white shadow-lg transition-transform duration-200 hover:scale-[1.03] active:scale-[0.98] md:bottom-7 md:right-7"
    >
