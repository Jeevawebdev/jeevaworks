...
export function HowItWorks() {
  return (
    <section id="how" className="bg-sea-soft px-5 py-20 md:px-8 md:py-28">
        ...
        <Stagger className="mt-14 grid gap-8 md:grid-cols-3" delay={0.05}>
          {steps.map((step, i) => (
            <StaggerItem key={step.title}>
              <div className="h-full border border-sea/15 bg-white/70 p-6 backdrop-blur-sm transition-transform duration-500 hover:-translate-y-1">
